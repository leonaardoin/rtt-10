class BadGuy {
    constructor(type, damage, health, attackShout, heroLevel, enemyLevel, fightAction) {
      this.type = type;
      this.damage = damage;
      this.health = health;
    ...
    {
    action (){
        console.log(`${this.type} does: ${this.fightAction}`);
        }
    }
    }
  }
  ...
  class BadGuyFactory {
    ...
    makeNewBadGuy(damage, health, attackShout, heroLevel, enemyLevel, heroLevel, enemyLevel, fightAction) {
      const newBadGuy = new BadGuy(this.factoryType, damage, health, attackShout, heroLevel, enemyLevel, fightAction);
